...
INSERT INTO Student(classId, userId, firstname, lastname, depositAmount, toPayAmount) VALUES (1, 5, 'Tom', 'Turbo', 22.8, 30.5);

INSERT INTO Student(classId, userId, firstname, lastname, depositAmount, toPayAmount) VALUES (2, 4, 'Alice', 'Anderson', 15.2, 25.7);
INSERT INTO Student(classId, userId, firstname, lastname, depositAmount, toPayAmount) VALUES (2, 5, 'Tom', 'Turbo', 2.8, 302.5);
...
INSERT INTO Student(classId, userId, firstname, lastname, depositAmount, toPayAmount) VALUES (4, 4, 'Alice', 'Anderson', 20.0, 30.5);
INSERT INTO Student(classId, userId, firstname, lastname, depositAmount, toPayAmount) VALUES (4, 5, 'Tom', 'Turbo', 2.8, 302.5);
INSERT INTO Student(classId, userId, firstname, lastname, depositAmount, toPayAmount) VALUES (4, 6, 'Charlie', 'Chaplin', 15.5, 12.8);

INSERT INTO Student(classId, userId, firstname, lastname, depositAmount, toPayAmount) VALUES (5, 5, 'Tom', 'Turbo', 2.8, 302.5);
